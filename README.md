<p align="center">
  <b>🌸 Sylphiette</b><br>
  <sub>Bot Discord auto-hébergé — t'installes, tu config, c'est chez toi</sub>
</p>
...
```bash
git clone https://github.com/Stiimy/discord-bot.git
cd discord-bot
python3 -m venv venv && source venv/bin/activate
pip install -r requirements.txt discord.py[voice] yt-dlp PyNaCl
cp .env.example .env  # mets ton token Discord dedans
python3 main.py
```
...
<p align="center">✨ fait avec les doigts par <a href="https://github.com/Stiimy">Stiimy</a> — <sub>nangalafou 🫡</sub></p>
